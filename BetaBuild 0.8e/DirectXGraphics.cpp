...
void CDirectXGraphics::ShowIntro()
{
	RECT r = {0,0,1024,768};
	D3DXLoadSurfaceFromFile(m_lpD3DSurface,0,&r,"res\\fsloading.png",0,D3DX_DEFAULT,0,NULL);
	m_lpD3DDevice->StretchRect(m_lpD3DSurface,&r,m_lpBackBuffer,0,D3DTEXF_NONE);
}
...
void CDirectXGraphics::GetGameBG(void){
	
	RECT r = {0,0,1024,768};
	D3DXLoadSurfaceFromFile(m_lpD3DSurface,0,&r,"res\\playbg.png",0,D3DX_DEFAULT,0,NULL);
	m_lpD3DDevice->StretchRect(m_lpD3DSurface,&r,m_lpBackBuffer,0,D3DTEXF_NONE);

}

void CDirectXGraphics::DrawCookie(void){
}

void CDirectXGraphics::DrawSnake(void){
}
